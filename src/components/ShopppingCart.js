                ...
                <div className='col-lg-9'>
                    <div className='row'>
                        <div className='col-lg-4'>
                            ...
                            <div className='row'>
                                <div className='col-lg-4'><img src="./Rectangle 34.png" alt="" /></div>
                                <div className='col-lg-8'>
                                    <h4 className='utc'>Ut diam consequat</h4>
                        ...
                        <div className='col-lg-8'>
                            <div className='row'>
                                ...
                                <div className='col-lg-4'>
                                    ...
                                    <h4 className='prct'>$12.00</h4>
                                </div>
                                <div className='col-lg-4'>
                                    <h1 className='mb-3 scp1'>Quantity</h1>
                                    <div className='row col-lg-8 mx-4 q-col'>
                                        <div className='col-lg-4'><i class="fas fa-minus"></i></div>
